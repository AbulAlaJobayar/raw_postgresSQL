-- Active: 1709236027427@@127.0.0.1@5432@company_db@public
...
ORDER BY employee_id LIMIT(2) OFFSET(2)
...
SELECT employee_name FROM employees
JOIN departments ON employees.department_id = departments.department_id WHERE departments.department_name= 'Engineering'
...
UPDATE employees
   SET status = 'Promoted' WHERE salary = (SELECT MAX(salary) from employees)
